...
if (isset($_FILES['profile_image'])) {
    ...
    $avatar = trim(filter_var($_FILES['profile_image'], FILTER_SANITIZE_STRING));
    $newAvatar = date("y-m-d H-i-s") . $avatar['name'];
    $destination =  __DIR__ . '/../../uploads/' . $newAvatar;
    ...
    $sql->bindParam(':profile_image', $newAvatar, PDO::PARAM_STR);
